...
const ATTENDU = {
  equipe: 'WASHINGTON',
  taille: 23,
  echantillon: {nom: 'Danton Heinen', salaire: 9075000, ct: 0, ov: 81},
  masseSousContrat: 60700000,
  nbSousContrat: 10,
  dateSecours: '1er août 2026',
  nbEchus: 13,
  nbBackups: 0,
  masseTotale: 103400000
};
...
(async () => {
  ...
  W.localStorage.removeItem('wsh_resignatures_v1');
  W.localStorage.removeItem('wsh_transac_v1');
